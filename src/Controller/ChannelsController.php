...
class ChannelsController extends AppController
{
    ...
    public function add()
    {
        ...
        $languages = $this->Channels->Languages->find('list', ['limit' => 200]);
        $matchs = $this->Channels->Matchs->find('list', ['limit' => 200]);
        $this->set(compact('channel', 'languages', 'matchs'));
        $this->set('_serialize', ['channel']);
    }
